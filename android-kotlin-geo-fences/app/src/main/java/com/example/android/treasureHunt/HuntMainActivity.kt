...
class HuntMainActivity : AppCompatActivity() {
    ...
    // variable to check if device is running Q or later
 ...
 */
    ...
    private fun addGeofenceForClue() {
        ...
        // remove already existing geofences in the pending intent
        geofencingClient.removeGeofences(geofencePendingIntent)?.run {
            addOnCompleteListener {
                geofencingClient.addGeofences(geofencingRequest, geofencePendingIntent)?.run {
                    addOnSuccessListener {
                        Toast.makeText(this@HuntMainActivity, R.string.geofences_added, Toast.LENGTH_SHORT)
                                .show()
